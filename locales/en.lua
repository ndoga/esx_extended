Locales['en'] = {
  ...
  ['received_item'] = 'Hai ricevuto %sx %s da %s',
  ...
  ['gave_account_money'] = 'Hai dato %s€ (%s) a %s',
  ['received_account_money'] = 'Hai ricevuto %s€ (%s) da %s',
  ...
  -- Salary related
  ['received_salary'] = 'Hai ricevuto la tua busta paga pari a €%s',
  ['received_help'] = 'Hai ricevuto il reddito di cittadinanza pari a €%s',
  ['company_nomoney'] = 'L\'azienda per cui lavori non ha soldi sufficienti per pagarti lo stipendio',
